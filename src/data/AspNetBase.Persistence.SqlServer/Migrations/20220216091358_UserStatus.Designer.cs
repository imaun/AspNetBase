...
namespace Datiss.Auditing.Persistence.SqlServer.Migrations
{
    ...
    [Migration("20220216091358_UserStatus")]
            ...
            modelBuilder.Entity("Datiss.Auditing.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "f7b5a209-0695-4dd0-8b9a-0852ab588f3c",
                            Description = "",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Datiss.Auditing.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e76da048-c166-4a1d-8ef0-7509aab92d29",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJLcg50g/oJAMiilwAPyfozsZ3tb+fO/u45Ms+3nTqHrALiMC0mzeGnbuyhPNw5lbQ==",
